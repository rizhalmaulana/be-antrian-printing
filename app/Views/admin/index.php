            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        <a href="<?= base_url('/dashboard/logout'); ?>" class="nav-link text-white font-weight-bold px-0">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total seluruh antrian</p>
                                    <h5 class="font-weight-bolder">
                                        <?= $total_semua; ?>
                                    </h5>
                                    <p class="mb-0">
                                        <span class="text-success text-sm font-weight-bolder">+20</span> sejak kemarin
                                    </p>
                                </div>
                            </div>
                            <div class="col-4 text-end">
